...
def build(s,d):
 ...
 for i,x in enumerate(c):
  old=x['case_id'];cid=old.replace('SYN-R3-','SYN-R14-');b=json.loads((s/'ai_outputs'/f'{old}.json').read_text(encoding='utf-8'));b['case_id']=cid
...
if __name__=='__main__':build(Path('data/10_round3'),Path('data/22_round14_improvement'))
