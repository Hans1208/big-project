...
// 온 값을 그대로 씁니다.
function InPersonRecordingControl({ hasCase, status, onStart, onStop }) {
...
function InPersonSttReferenceBadge({ sttResult }) {
...
function InPersonAnalysisPanel({ selectedCase, onUpdateConsultation, caseMeta }) {
  const hasCase = Boolean(selectedCase);
...
function ConsultationChannelTabs(props) {
